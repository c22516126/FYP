...
def get_cqt(inputs: tf.Tensor, n_harmonics: int, use_batchnorm: bool, filter_scale: float = 1.0) -> tf.Tensor:
...
def model(
    ...
    x = get_cqt(inputs, n_harmonics, True, filter_scale=filter_scale)
